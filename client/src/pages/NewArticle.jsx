...
const AddArticle = () => {
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        const response = await axios.get('https://blogs-production-0c60.up.railway.app/categories');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://blogs-production-0c60.up.railway.app/articles', formData);
