...
const Profile = () => {
  ...
  useEffect(() => {
    const fetchUserArticles = async () => {
      ...
      try {
        setIsLoading(true);
        const response = await axios.get(`https://blogs-production-0c60.up.railway.app/articles?author=${user._id}`);
...
//https://blogs-production-0c60.up.railway.app/user
  const removeArticle = async (id) => {
   try {
     setIsLoading(true);
     await axios.delete(`https://blogs-production-0c60.up.railway.app/articles/${id}`);
